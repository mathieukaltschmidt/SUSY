...
\only<4>{
We could use \textit{matter parity}
\begin{align}
P_\mathrm{m}&=(-1)^{3(B-L)},
\end{align}
...
\begin{align}\nonumber
  -\mathcal{L}^\mathrm{MSSM}_\mathrm{soft}\supset&\frac12M_i\tilde{\lambda}_i\tilde{\lambda}_i+M^2_{\tilde{F}}\tilde{f}^\dagger\tilde{f}\\
...
$\color{cyan}{\tilde{d}_L}$&$\color{cyan}{\tilde{d}_R}$&$\color{cyan}{\tilde{s}_L}$&$\color{cyan}{\tilde{s}_R}$&$\color{cyan}{\tilde{b}_L}$&$\color{cyan}{\tilde{b}_R}$&&$\tilde{g}$&$\color{orange}{\tilde{W}^\pm}$\\\\
...
\begin{table}
\begin{tabular}{ccccccccc}
$\color{olive}{\tilde{q}_1}$&$\color{olive}{\tilde{q}_2}$&$\color{olive}{\tilde{q}_3}$&$\color{olive}{\tilde{q}_4}$&$\color{olive}{\tilde{q}_5}$&$\color{olive}{\tilde{q}_6}$&&$\color{orange}{\tilde{\chi}^\pm_1}$&$\color{orange}{\tilde{\chi}^\pm_2}$\\
$\color{cyan}{\tilde{q}'_1}$&$\color{cyan}{\tilde{q}'_2}$&$\color{cyan}{\tilde{q}'_3}$&$\color{cyan}{\tilde{q}'_4}$&$\color{cyan}{\tilde{q}'_5}$&$\color{cyan}{\tilde{q}'_6}$&&$\tilde{g}$&\\\\
...
\begin{itemize}
\item The charged gauginos ($\tilde{W}^\pm$, $\tilde{H}_u^+$, $\tilde{H}_d^-$) form the charginos $\tilde{\chi}^\pm_i$.
\item The neutral gauginos ($\tilde{B}$, $\tilde{W}^0$, $\tilde{H}_u^0$, $\tilde{H}_d^0$) form the neutralinos $\tilde{\chi}^0_i$.
\item The squarks ($\tilde{q}_{i, L}$, $\tilde{q}_{i, R}$) form mass eigenstates labeled $\tilde{q}_i$.
\item The sleptons ($\tilde{e}_{i, L}$, $\tilde{e}_{i, R}$) form eigenstates $\tilde{\ell}_i$.
