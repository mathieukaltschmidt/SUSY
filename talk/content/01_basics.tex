...
\begin{align}\nonumber
  W=&\lambda_d\left[H_dQD\right]_\numb{1}+\lambda_e\left[H_dLE\right]_\numb{1}-\lambda_u\left[H_uQU\right]_\numb{1}+\mu \left[H_uH_d\right]_\numb{1}\\
...
\only<3>{
At tree level this implies an upper bound on the mass of the lightest Higgs:
\begin{align}
  m_h&\le m_Z\left|\cos2\beta\right|.
\end{align}
}
\end{frame}
