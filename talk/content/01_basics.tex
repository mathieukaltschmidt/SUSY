...
\only<3>{The Standard Model of Particle Physics has 19 free parameters with $v$ being the only one carrying a physical dimension.\footnote{14 real parameters, 3 mixing angles, 2 CP-violating phase.}}
\end{frame}
\section{The MSSM}
\subsection{Basics}
...
\begin{align}\nonumber
  W=&\lambda_d\left[\hat{H_d}\hat{Q}\hat{D}\right]_\numb{1}+\lambda_e\left[\hat{H_d}\hat{L}\hat{E}\right]_\numb{1}-\lambda_u\left[\hat{H_u}\hat{Q}\hat{U}\right]_\numb{1}+\mu \left[\hat{H_u}\hat{H_d}\right]_\numb{1}\\
